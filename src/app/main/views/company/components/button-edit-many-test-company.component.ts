...
@Component({
  selector: 'app-button-edit-many-test-company',
  template: `
...
export class ButtonEditManyTestCompanyComponent implements OnInit {
  ...
  onEditMany(values: Company[]): void {
    ...
    this.store$.dispatch(CompanyStoreActions.EditManyRequest({items}));
  }
