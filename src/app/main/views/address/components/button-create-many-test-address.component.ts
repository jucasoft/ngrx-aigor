...
@Component({
  selector: 'app-button-create-many-test-address',
  template: `
...
export class ButtonCreateManyTestAddressComponent implements OnInit {
  ...
  onCreateMany(values: Address[]): void {
    ...
    this.store$.dispatch(AddressStoreActions.CreateManyRequest({items}));
  }
