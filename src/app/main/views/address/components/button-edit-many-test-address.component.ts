...
@Component({
  selector: 'app-button-edit-many-test-address',
  template: `
...
export class ButtonEditManyTestAddressComponent implements OnInit {
  ...
  onEditMany(values: Address[]): void {
    ...
    this.store$.dispatch(AddressStoreActions.EditManyRequest({items}));
  }
